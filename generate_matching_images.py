...
from samplers.samplers_sd import sample_match_sd
from utils import add_args, save_metadata, save_mc
...
for p in args.prompts:
    prompt_embeds.append(sd_pipeline.encode_prompt(p,
                                                   device="cuda",
...
for i in range(args.num_samples):
    ...
    # Sample 64x64 image
    images = sample_match_sd(sd_pipeline, 
                           prompt_embeds,
