...
<div>
  <div style="display: flex; flex-wrap: wrap; gap: 10px; width: 1310px; justify-content: center;">
    <div style="flex: none;">
      <img src="assets/flower_fireworks.gif" alt="Flower Fireworks" width="200" style="display: block;">
    </div>
    <div style="flex: none;">
      <img src="assets/bone_spaceship.gif" alt="Bone Spaceship" width="200" style="display: block;">
    </div>
    <div style="flex: none;">
      <img src="assets/highway_iceskating.gif" alt="Highway Iceskating" width="200" style="display: block;">
    </div>
    <div style="flex: none;">
      <img src="assets/waves_ants.gif" alt="Waves Ants" width="200" style="display: block;">
    </div>
  </div>
</div>
